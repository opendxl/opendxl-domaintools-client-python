...
RELEASE_NAME = "dxldomaintoolsclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxldomaintoolsclient")])
...
print("\nRemoving dxldomaintoolsclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxldomaintoolsclient.egg-info"))
